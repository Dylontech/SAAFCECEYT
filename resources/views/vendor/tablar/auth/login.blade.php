            ...
            <div class="card-body">
                ...
                <form action="{{route('login')}}" method="post" autocomplete="off" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Usuario@hotmail.com" autocomplete="off">
                        @error('email')
                        ...
                        <a href="https://wa.me/4471103795?text=Buen%20dia%20apreciable%20alumno.%20%C2%BFEn%20que%20podemos%20ayudarte%3F%2C%20te%20recordamos%20que%20el%20horario%20de%20atencion%20es%20de%208%20de%20la%20ma%C3%B1ana%20a%203%20de%20la%20tarde%2C%20agradecemos%20tu%20entendimiento."
                           class="btn btn-white w-100">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon text-whatsapp" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                <path d="M3 21l1.65 -4.65a8 8 0 1 1 3.6 3.6l-4.65 1.65m4.65 -1.65a8 8 0 1 0 -3.6 -3.6"/>
                                <path d="M9 10a1 1 0 0 1 1 -1h1a1 1 0 0 1 1 1v1a1 1 0 0 0 1 1h1a1 1 0 0 1 1 1v1a1 1 0 0 1 -1 1h-1a1 1 0 0 1 -1 -1v-1a1 1 0 0 0 -1 -1h-1a1 1 0 0 1 -1 -1v-1"/>
                            </svg>
